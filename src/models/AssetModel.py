...
class AssetModel(BaseDataModel):
    ...
    async def create_asset(self, asset: Asset):
        asset_dict = asset.dict(by_alias=True, exclude_unset=True) #we use the by_alias to get the _id instead of id and we use the exclude_unset to exclude the fields that are not set (in this case the _id)
